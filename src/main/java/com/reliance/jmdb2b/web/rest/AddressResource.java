...
import com.reliance.jmdb2b.repository.AddressRepository;
...
/**
 * REST controller for managing {@link com.reliance.jmdb2b.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Address> partialUpdateAddress(
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getGst() != null) {
                    existingAddress.setGst(address.getGst());
                }
                if (address.getLandmark() != null) {
                    existingAddress.setLandmark(address.getLandmark());
                }
                if (address.getAddressStatus() != null) {
                    existingAddress.setAddressStatus(address.getAddressStatus());
                }
