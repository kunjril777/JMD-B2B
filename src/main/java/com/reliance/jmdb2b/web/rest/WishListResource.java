...
/**
 * REST controller for managing {@link com.reliance.jmdb2b.domain.WishList}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<WishList> result = wishListRepository
            ...
            .map(existingWishList -> {
                if (wishList.getWishListName() != null) {
                    existingWishList.setWishListName(wishList.getWishListName());
                }
                if (wishList.getCreatedTime() != null) {
                    existingWishList.setCreatedTime(wishList.getCreatedTime());
                }
                if (wishList.getUpdatedTime() != null) {
                    existingWishList.setUpdatedTime(wishList.getUpdatedTime());
                }
                if (wishList.getCreatedBy() != null) {
                    existingWishList.setCreatedBy(wishList.getCreatedBy());
                }
                if (wishList.getUpdatedBy() != null) {
                    existingWishList.setUpdatedBy(wishList.getUpdatedBy());
                }
